...
img = cv2.imread('photos/text2.2.png')
...
cv2.imwrite('final_Otsu2.png', final_otsu_img)

#Niblack Method
niblack_img = niblack_method(bw_img, k=0.2, w_s=15)
cv2.imwrite('final_Niblack2.png', niblack_img)

#Sauvola Method
sauvola_img = sauvola_method(bw_img, k=0.2, w_s=15)
cv2.imwrite('final_Sauvola2.png', sauvola_img)

#Сhristian Method
christian_img = christian_method(bw_img, k=0.2, w_s=15)
cv2.imwrite('final_Christian2.png', christian_img)